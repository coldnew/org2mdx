...
[ClojureScript](https://github.com/clojure/clojurescript/wiki/Differences-from-Clojure) 是相當於 Clojure 在 javascript 上的實現，由 Clojure 團隊所設
...
ClojureScript 的編譯器使用 Clojure 來撰寫，並使用 [Google Closure
Compiler](https://developers.google.com/closure/compiler/?hl=zh-TW) 來將編譯出來的 javascript 程式進行最佳化，對於喜歡 Lisp 又想體
驗 node.js 的開發者，這是一個非常有吸引力的語言。想了解 ClojureScript
更多，你可以參考 [ClojureScript 通過 Javascript 將 Clojure 引入到瀏覽
器端](http://www.infoq.com/cn/news/2011/08/clojurescript) 一文。
...
無論是使用 Clojure 開發還是 ClojureScript 開發， [Leiningen](https://github.com/technomancy/leiningen) 都是幫忙
建立開發環境的好幫手，安裝完 [Leiningen](https://github.com/technomancy/leiningen) 後，你需要在
**~/.lein/profiles.clj** 加上名為 [lein-cljsbuild](https://github.com/emezeske/lein-cljsbuild) 的 lein 擴展
...
剩下的兩行則是 [Google Closure Compiler](https://developers.google.com/closure/compiler/?hl=zh-TW) 的設置，我們設定最佳化的方法
...
在 [Running ClojureScript on Node.js](https://github.com/clojure/clojurescript/wiki/Quick-Start) 裏面說到了你必須設定一個進入點
