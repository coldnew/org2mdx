...
tags:
  ...
  - bash
category:
  - 使用 C++ 實現一個簡單的 Coding Agent
description: Generated from Org-mode
---

用久了 [claude](https://claude.com/), [codex](https://chatgpt.com/codex), [opencode](https://opencode.ai/) 後，很好奇這些 coding agent 是怎樣實作的，於是花了一點時間研究一下，並寫一個簡單但是可以使用的 coding agent 作為練習。
...
要寫一個 coding agent 前，除了選擇要用的程式語言外，就是如何獲得可以使用的 Model 了，本文選用 [openrouter](https://openrouter.ai/) 作為我們模型的來源，選用他的原因是它提供了一般使用者 [免費的模型](https://openrouter.ai/openrouter/free) , 這樣即使是沒錢可以訂閱 (或是不想花錢) 但是想研究 coding agent 的實現的人也可以實現自己的 agent。

由於使用 [openrouter](https://openrouter.ai/) 免費的模型需要獲得 `API KEY` , 因此讓我們先登入這個網頁

# 註冊 openrouter 並獲得 API Key

我們登入到 [openrouter](https://openrouter.ai/) 去，如果沒有帳號的需要自行註冊，或是透過 Google/Github 等帳號登入

![img](%E4%BD%BF%E7%94%A8-C++-%E5%AF%A6%E7%8F%BE%E4%B8%80%E5%80%8B%E7%B0%A1%E5%96%AE%E7%9A%84-Coding-Agent-%E5%BE%9E-curl-%E5%91%BC%E5%8F%AB%E9%96%8B%E5%A7%8B/1.png)

登入完成後，點選 `Settings`

![img](%E4%BD%BF%E7%94%A8-C++-%E5%AF%A6%E7%8F%BE%E4%B8%80%E5%80%8B%E7%B0%A1%E5%96%AE%E7%9A%84-Coding-Agent-%E5%BE%9E-curl-%E5%91%BC%E5%8F%AB%E9%96%8B%E5%A7%8B/2.png)

接下來點選 `API Keys` 欄位，並建立自己的 `API Key`

![img](%E4%BD%BF%E7%94%A8-C++-%E5%AF%A6%E7%8F%BE%E4%B8%80%E5%80%8B%E7%B0%A1%E5%96%AE%E7%9A%84-Coding-Agent-%E5%BE%9E-curl-%E5%91%BC%E5%8F%AB%E9%96%8B%E5%A7%8B/3.png)

這邊的 API Key 名稱是為了讓自己可以辨識這是哪個用途的，可以任意自訂，這邊設定 `my agent` 並允許全部權限以及不會過期 (No expiration)

![img](%E4%BD%BF%E7%94%A8-C++-%E5%AF%A6%E7%8F%BE%E4%B8%80%E5%80%8B%E7%B0%A1%E5%96%AE%E7%9A%84-Coding-Agent-%E5%BE%9E-curl-%E5%91%BC%E5%8F%AB%E9%96%8B%E5%A7%8B/4.png)

點選箭頭的位置複製你的 `API Key` ，這邊注意到一但你離開這個頁面後，就再也無法找到這份號碼，因此一定要好好保存

![img](%E4%BD%BF%E7%94%A8-C++-%E5%AF%A6%E7%8F%BE%E4%B8%80%E5%80%8B%E7%B0%A1%E5%96%AE%E7%9A%84-Coding-Agent-%E5%BE%9E-curl-%E5%91%BC%E5%8F%AB%E9%96%8B%E5%A7%8B/5.png)
...
接下來我們就可以用 [curl](https://curl.se) 命令來進行簡單的測試，免費的模型名稱為 `openrouter/free` , 而 API 端點為 [https://openrouter.ai/api/v1/chat/completions](https://openrouter.ai/api/v1/chat/completions) , 所以這樣下命令 (記得在環境變數 `OPENROUTER_API_KEY` 裡面設定好你的 API Key)
...
可以看到我們想要的訊息在 `choices.message.content` 這邊，因此如果有將訊息保存，並使用 [jq](https://jqlang.org) 將其撈出來的話，可以獲得 AI 端的訊息，因此我們可以搭配 [jq](https://jqlang.org) 下我們的命令:
