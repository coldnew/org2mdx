...
date: "2015-09-22T17:17:00.000Z"
updated: "2015-09-22T17:17:00.000Z"
abbrlink: 5c119546
tags:
  - clojure
  - javafx
  - clojurescript
alias:
  - blog/2015/09-23_clojure_javafx_webview/index.html
  - blog/2015/building_a_desktop_application_with_clojure_and_javafx_webview.html
description: Generated from Org-mode
---

在 [使用 clojurescript 和 electron 來打造桌面程式](http://coldnew.github.io/blog/2015/building_a_desktop_application_with_cljs_and_electron.html) 一文中我們說到了如何使用 electron 搭配 clojurescript 達到在 Node.js 平台使用 HTML 5 來打造桌面程式的方法， 這一次則是來談談如何使用 Clojure 搭配 JavaFX WebView 辦到類似的事情。
...
在這範例中，我們是直接讓 WebView 去載入 [http://coldnew.github.io](http://coldnew.github.io) ，也因此當你使 用 `lein` 去執行這隻程式的時候，你就會看到有一個視窗跑出來，並且載入了我們目標的 網頁。
...
![img](%E4%BD%BF%E7%94%A8-Clojure-%E5%92%8C-JavaFX-Webview-%E6%89%93%E9%80%A0%E6%A1%8C%E9%9D%A2%E7%A8%8B%E5%BC%8F/simple_javafx.png)
...
`[1]` [Hello JavaFX! Part 1](http://www.codedata.com.tw/java/hello-java-fx-part1/)