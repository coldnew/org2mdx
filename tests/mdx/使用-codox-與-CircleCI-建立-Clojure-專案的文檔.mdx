...
date: "2016-02-20T13:50:00.000Z"
updated: "2016-02-20T13:50:00.000Z"
abbrlink: 2c9c3b0f
author: coldnew
...
tags:
  ...
  - clojurescript
alias:
  - blog/2016/02/21_codox/index.html
description: Generated from Org-mode
---

在 Clojure 世界中，常用的產生文檔工具有 [Marginalia](https://github.com/MichaelBlume/marginalia) 以及 [Codox](https://github.com/weavejester/codox)。 本文將講述如何透過 [Codox](https://github.com/weavejester/codox) 以及 [Circle CI](https://circleci.com) 來對你的函式庫進行測試以及產生文檔並發佈到 GitHub pages 去。
...
首先我們先透過 [leinigen](http://leiningen.org/) 產生我們 Clojure 專案的基本樣板，這邊命名該專案為 `example-lib`
...
![img](%E4%BD%BF%E7%94%A8-codox-%E8%88%87-CircleCI-%E5%BB%BA%E7%AB%8B-Clojure-%E5%B0%88%E6%A1%88%E7%9A%84%E6%96%87%E6%AA%94/index.png)

# 讓 Circle CI 發佈你的文檔到 gh-pages

自從 GitHub 加入了顯示 [gh-pages](https://pages.github.com/) 的 html 檔案功能後，我們就可以存放我們的 HTML 文檔到 gh-pages 分支去，不過先讓我們加入 [Circle CI](https://circleci.com) 的支援。
...
![img](%E4%BD%BF%E7%94%A8-codox-%E8%88%87-CircleCI-%E5%BB%BA%E7%AB%8B-Clojure-%E5%B0%88%E6%A1%88%E7%9A%84%E6%96%87%E6%AA%94/circleci1.png)

第一次編譯的時候你會發現失敗在 *deploy.sh* 這裡，這是因為 CircleCI 沒有權限可以將你產生的文檔上傳到 GitHub 去

![img](%E4%BD%BF%E7%94%A8-codox-%E8%88%87-CircleCI-%E5%BB%BA%E7%AB%8B-Clojure-%E5%B0%88%E6%A1%88%E7%9A%84%E6%96%87%E6%AA%94/circleci2.png)
...
![img](%E4%BD%BF%E7%94%A8-codox-%E8%88%87-CircleCI-%E5%BB%BA%E7%AB%8B-Clojure-%E5%B0%88%E6%A1%88%E7%9A%84%E6%96%87%E6%AA%94/circleci3.png)

接下來到你該專案的 GitHub 頁面去，我們進入到這個專案的 *Deploy keys* 頁面，將 `id_rsa.pub` 貼上。

![img](%E4%BD%BF%E7%94%A8-codox-%E8%88%87-CircleCI-%E5%BB%BA%E7%AB%8B-Clojure-%E5%B0%88%E6%A1%88%E7%9A%84%E6%96%87%E6%AA%94/circleci4.png)

都完成後，讓 *CircleCI* 對你專案進行 `Rebuild` 的動作，你就會看到你的 *gh-pages* 多出了新建立的文檔囉。

# 取得本文的範例

本文的範例已經上傳到 [GitHub](https://github.com/clojure-tw/example-codox-circleci), 你可以透過以下命令下載到本地來查看
...
產生出來的線上文件則可以到 [http://clojure-tw.github.io/example-codox-circleci/](http://clojure-tw.github.io/example-codox-circleci/) 去看。
